class CountryModelEntity {
  ...
  CountryModelEntity.fromJson(Map<String, dynamic> json) {
    name = json['name'];
...
//			data['borders'] = this.borders.map((v) => v).toList();
//		}
...
class Currencies {
  ...
  Currencies.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    name = json['name'];
    if (json['symbol'] != null && json['symbol'] != "")
      symbol = json['symbol'];
    else
      symbol = "N/A";
  }
...
//			data['otherAcronyms'] =
//					this.otherAcronyms.map((v) => v).toList();
//		}
//		if (this.otherNames != null) {
//			data['otherNames'] = this.otherNames.map((v) => v).toList();
//		}
    return data;
  }
}
